...
func main() {
	...
	fmt.Println("\n Below are all the search trend for today!")
	fmt.Println("--------------------------------------------")
	...
	for i := range r.Channel.ItemList {
		...
		fmt.Println("Headine", r.Channel.ItemList[i].NewsItem[0].Headline)
		fmt.Println("Link to the article", r.Channel.ItemList[i].NewsItem[0].HeadlineLink)
		fmt.Println("--------------------------------------------")
	}
}
